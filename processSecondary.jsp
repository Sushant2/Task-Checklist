        ...
        while ((line = input.readLine()) != null) {
            ...
            if(firstLine){
                ...
                for(String colName : columnOrder){
                    if(colName.indexOf("Task") != -1 || colName.indexOf("Item") != -1)
                        orderSave.add(0);
            ...
            while(i<orderSave.size()){
                ...
                if(orderSave.get(i) == 1){
                    ...
                    secondaryName = columns[orderSave.indexOf(20)];
            ...
            if(orderSave.size()>16 && orderSave.contains(16) && orderSave.contains(17)){
                startRem = "";
            ...
            if(orderSave.indexOf(19) != -1){
                description = "";
                if(orderSave.indexOf(19) < row.length)
